...
# Или используйте внешний IP (если бот на другой машине или для внешнего доступа):
SERVER_URL=http://80.87.105.61:8001
```

**Рекомендация:** Если бот запущен на том же сервере, используйте `127.0.0.1:8001`. Если бот на другой машине или нужен внешний доступ - используйте `80.87.105.61:8001`.
